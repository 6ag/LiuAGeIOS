...
class JFPresentationController: UIPresentationController {
    ...
    override func containerViewWillLayoutSubviews() {
        ...
        presentedView?.frame = CGRect(x: 0, y: 64, width: SCREEN_WIDTH, height: SCREEN_HEIGHT - 64)
        
        // 关闭按钮
        let closeButton = UIButton(frame: CGRect(x: SCREEN_WIDTH - 40, y: 0, width: 40, height: 40))
        closeButton.setImage(UIImage(named: "channel_nav_plus"), for: UIControlState())
