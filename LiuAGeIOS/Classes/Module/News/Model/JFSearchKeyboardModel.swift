...
class JFSearchKeyboardModel: NSObject {
    ...
    /**
     ...
     - parameter finished: 数据回调
     */
    class func loadSearchKeyListFromLocationOrderByNum(finished: @escaping (_ searchKeyboardModels: [JFSearchKeyboardModel]?, _ error: NSError?) -> ()) {
        
        JFNewsDALManager.shareManager.loadSearchKeyListFromLocationOrderByNum() { (success, result, error) in
