...
class JFArticleListModel: NSObject {
     ...
     */
    class func cleanCache(_ classid: String) {
     ...
     */
    class func loadNewsList(_ classid: String, pageIndex: Int, type: Int, cache: Bool, finished: @escaping (_ articleListModels: [JFArticleListModel]?, _ error: NSError?) -> ()) {
