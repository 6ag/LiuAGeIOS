    ...
    var postModel: JFArticleListModel? {
        didSet {
            ...
            if postModel!.titlepic!.hasSuffix("gif") {
                ...
                iconView1.yy_setImageWithURL(NSURL(string: postModel!.morepic![0]), placeholder: UIImage(named: "list_placeholder"), options: YYWebImageOptions.ProgressiveBlur, completion: nil)
            }
            ...
            if postModel!.titlepic!.hasSuffix("gif") {
                ...
                iconView2.yy_setImageWithURL(NSURL(string: postModel!.morepic![1]), placeholder: UIImage(named: "list_placeholder"), options: YYWebImageOptions.ProgressiveBlur, completion: nil)
            }
            ...
            if postModel!.titlepic!.hasSuffix("gif") {
                ...
                iconView3.yy_setImageWithURL(NSURL(string: postModel!.morepic![2]), placeholder: UIImage(named: "list_placeholder"), options: YYWebImageOptions.ProgressiveBlur, completion: nil)
            }
