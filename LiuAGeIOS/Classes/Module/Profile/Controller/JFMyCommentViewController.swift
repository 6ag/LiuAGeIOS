//
//  JFMyCommentViewController.swift
//  BaoKanIOS
//
...
class JFMyCommentViewController: UIViewController {
...
extension JFMyCommentViewController: UITableViewDataSource, UITableViewDelegate {
