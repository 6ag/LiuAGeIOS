...
extension JFNetworkTool {
    ...
    /**
     ...
     - parameter finished:  数据回调
     */
    func loadNewsListFromNetwork(_ classid: String, pageIndex: Int, type: Int, finished: @escaping NetworkFinished) {
    ...
    /**
     ...
     - parameter finished: 数据回调
     */
    func loadNewsDetailFromNetwork(_ classid: String, id: String, finished: @escaping NetworkFinished) {
    ...
    /**
     ...
     - parameter finished:  数据回调
     */
    func loadCommentListFromNetwork(_ classid: String, id: String, pageIndex: Int, pageSize: Int, finished: @escaping NetworkFinished) {
...
extension JFNetworkTool {
    ...
    func getCurrentNetworkState() -> Int {
        ...
        var networkState = 0
        switch appDelegate.hostReach?.currentReachabilityStatus() ?? NotReachable {
        case NotReachable:
            networkState = 0
            log("无网络")
